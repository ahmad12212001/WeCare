...
namespace WeCare.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230516201917_ModifyCourseAddMajorGroupRelationNotNull")]
    partial class ModifyCourseAddMajorGroupRelationNotNull
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeCare.Domain.Entities.Material", b =>
                {
                    b.HasOne("WeCare.Domain.Entities.Course", null)
                        .WithMany("Materials")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WeCare.Domain.Entities.Request", null)
                        .WithMany("Material")
