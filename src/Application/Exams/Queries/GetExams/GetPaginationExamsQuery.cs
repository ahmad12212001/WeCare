...
[Authorize]
public record GetPaginationExamsQuery : IRequest<PaginatedList<ExamDto>>
...
public class GetPaginationExamsQueryHandler : IRequestHandler<GetPaginationExamsQuery, PaginatedList<ExamDto>>
{
    private readonly IApplicationDbContext _context;
    private readonly IMapper _mapper;

    public GetPaginationExamsQueryHandler(IApplicationDbContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }
    public async Task<PaginatedList<ExamDto>> Handle(GetPaginationExamsQuery request, CancellationToken cancellationToken)
    {
